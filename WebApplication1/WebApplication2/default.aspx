...
<body class="blue lighten-3">
  ...
  <nav class="purple">
      <ul class="right">
          <li><a href="#!" class="yellow-text right">EASY-TRAVEL</a></li>
      </ul>
  </nav>
  ...
  <div class="row">
	...
	<div class="col s12 l4 step">
        ...
        <div class="row">
            <br />
            <a href="agency/index.aspx" class="right waves-effect waves-light purple-text" ><u>Create Agency Tie-Ups with our Web-App &rarr;</u></a>
        </div>
    </div>
  </div>
    ...
    <div class="row">
        ...
        <div class="col s12 m5 card-panel yellow">
          <h5 class="purple-text center">Our Team</h5>
            <br />
            ...
            <div class="row">
                ...
                <div class="col s12 m6 purple-text">
                   <h6 class="teal-text center">Ravinder Singh</h6>
                    <ol type="disc">
            ...
            <div class="row">
                ...
                <div class="col s12 m6 purple-text">
                   <h6 class="teal-text center">Sagar Patel</h6>
                    <ol type="disc">
                       <li>B.TECH<sup>*</sup>(Computer) 3<sup>rd</sup> Year.</li>
                       <li>Web-Developer.</li>
        ...
        <div class="col s12 m4 card-panel yellow">
            <div>
