<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="WebApplication2.agency.WebForm1" %>
...
<body class="blue lighten-4">
  ...
  <div class="row">
    ...
    <div id="traveller" class="col s12 purple-text">
        ...
        <div class="row">
            <br />
            <a href="../default.aspx" class="right waves-effect waves-light purple-text" ><u>Join the Travellers Group &rarr;</u></a>
        </div>
    </div>
